...
public class returning extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet returning</title>");
            out.println("</head>");
            out.println("<body>");
         ...
         HttpSession session = request.getSession(false);
          if (session != null) {
            ...
            int j = st.executeUpdate("delete from issue where id ='" + st1 + "' and code ='" + st2 + "'");

            if (j > 0) {
                out.println("<html><body><h1>The book is Returned</h1></body></html>");
            } else {
