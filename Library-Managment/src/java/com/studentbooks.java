 ...
 * @author Dell
 */
public class studentbooks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session != null) {
                ...
                out.println("<font color='#D1E8E2'>Currently existing Books are......</font>"); 
                if (true) {
                    out.println("<html><head></head><body bgcolor=#1ea5a8><table border=2 width=50% height=50%><tr><th>NAME</th><th>CODE</th><th>AUTHOR</th><th>PRICE</th><th>RACK_NO</th><th>NO_OF_BOOKS</th></tr>");
                }
                while (rs.next()) {
